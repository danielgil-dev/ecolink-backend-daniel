        ...
        public void run(String... args) throws Exception {
                ...
                List<Post> posts = Arrays.asList(
                                ...
                                new Post(
                                                ecoPackaging,
                                                responsibleConsumption,
                                                "EcoPackaging: Sustainable packaging solutions",
                                                "We develop biodegradable packaging to reduce plastic waste.",
                                                LocalDate.now().minusDays(23)),

                                new Post(
                                                sustainableFashion,
                                                decentWorkEconomicGrowth,
                                                "SustainableFashion: Ethical and fair fashion",
                                                "We promote fair wages and sustainable practices in the fashion industry.",
